...
output_folder_name = "negbleurtForest_processed_evaluated_single_prompts_without_summ"
...
def classifier_neg_bleurt_without_threshold(
    ...
    for target_response in target_responses:
        ...
        target_responses_summrized.append(target_response)
        extracted_sentences.append(target_response)
